function getRankHeroe(victories,defeats ){

    let result = calculateResult(victories, defeats);
  ...
  function calculateResult(victories, defeats){
    let result = victories - defeats;
    return result;
  }
  
  module.exports = getRankHeroe;